...
class EfficientNet(nn.Module):
    ...
    def __init__(self, outblocks, outstrides, blocks_args=None, global_params=None):
        ...
        inputs = torch.ones((1, 5, 256, 256))#CAMBIO
    ...
    def from_name(
        ...
        cls, model_name, outblocks, outstrides, in_channels=5, **override_params#CAMBIO
    ):
